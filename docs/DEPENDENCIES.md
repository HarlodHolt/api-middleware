...
All three application repos reference `api-middleware` as a **git dependency** in their `package.json`. This means they pin to specific git commits/tags rather than a published npm package.
